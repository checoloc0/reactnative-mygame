import {  Button, Dimensions, Keyboard, Pressable, StyleSheet,Text,TextInput,TouchableWithoutFeedback,View,KeyboardAvoidingView,Platform } from "react-native";
        ...
        {confirmed && 
            (
               <Card newStyles={{marginTop:50, width:150}}>
                  <Text>
                        El número de que elegiste es:
                    </Text>
                    <Text>{selectedNumber}</Text>
           
                    <Button title="Iniciar Juego" onPress={() => onStartGame(selectedNumber)}/>
               </Card>
            )
